...
class Graph:
    ...
    def dftr_helper(self, vert, visited):
        visited.add(vert)
        print(vert)
        for next_vert in self.get_neighbors(vert):
            if next_vert not in visited:
                self.dftr_helper(next_vert, visited)
    ...
    def dft_recursive(self, starting_vertex):
        ...
        """
        visited = set()
        self.dftr_helper(starting_vertex, visited)
    ...
    visited=None, path=None):
        ...
        if starting_vertex == destination_vertex:
            found = True
            print(f"found: {starting_vertex} at {newpath}")
            return newpath
